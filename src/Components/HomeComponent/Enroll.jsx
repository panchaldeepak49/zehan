    ...
    <div className='mt-14 w-[90%] flex justify-evenly'>
        ...
        {/* <div className='w-[50%] flex flex-col justify-end mt-20 '>
            ...
            <img src={rectangleEnrollHeadImg} className=' w-[100%] '></img>
                ...
                <button className='lg:px-10 md:px-7 sm:px-3 px-2 md:mt-6 sm:mt-4 mt-2 mb-2 md:py-1 sm:py-0.2 py-0.2 rounded-md bg-[#4739FF] sm:text-[1rem] text-[0.75rem] text-white'>Submit</button>
            </div>
