...
const TopCategories = () => {
  return (
    ...
    <div className='flex flex-col items-center mt-10'>
        ...
        <p className='mt-5 md:w-[50%] sm:w-[55%] text-center md:text-[1rem] sm:text-[0.75rem] text-[#4A4A4A]'>Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a
