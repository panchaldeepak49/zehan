  ...
  return (
    ...
    <div className='flex justify-between w-full h-[34rem] bg-gradient-to-r from-red-50 via-red-300 via-red-400 via-sky-300 to-red-200 '>
        <div className='w-[60%] md:mt-28 sm:mt-20 mt-16 md:ml-28 sm:ml-20 ml-5'>
            <p className='xl:text-[4.5rem] lg:text-[3.35rem] md:text-[2.4rem] sm:text-[1.95rem] text-[1.75rem] font-bold text-[#002B46]'>HTML, CSS <span className='text-[#525FE1]'>JavaScript </span> </p>
            <p className='xl:text-[4.5rem] lg:text-[3.35rem] md:text-[2.4rem] sm:text-[1.95rem] text-[1.75rem] font-bold text-[#002B46] md:-mt-6'>Training Program</p>
            <p className='w-[70%] sm:text-[10px] lg:text-[1rem] text-[0.7rem] mt-4'>Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document
